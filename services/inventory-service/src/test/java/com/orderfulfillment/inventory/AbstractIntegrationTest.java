...
/**
 * Base for Inventory Service's Testcontainers-backed integration tests. See
 * order-service's {@code AbstractIntegrationTest} Javadoc for the shared rationale: only this
 * service is started; upstream services (Order, Payment) are simulated by publishing the same
 * wire-format events they would send, via this service's own {@link EventPublisher} bean.
 */
