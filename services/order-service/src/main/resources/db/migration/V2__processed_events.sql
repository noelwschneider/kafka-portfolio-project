-- Order Service's copy of the idempotency ledger. The shape is frozen in docs/db-ownership.md
...
-- consumers; within this service, order.inventory-events, order.payment-events and
-- order.fulfillment-events coexist here without colliding.
