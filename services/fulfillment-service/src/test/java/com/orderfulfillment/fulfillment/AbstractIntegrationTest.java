...
/**
 * Base for Fulfillment Service's Testcontainers-backed integration tests. See order-service's
 * {@code AbstractIntegrationTest} Javadoc for the shared rationale: only this service is started;
 * Payment Service is simulated by publishing PaymentAuthorized directly, via this service's own
...
abstract class AbstractIntegrationTest {
    ...
    /** Direct reads of the processed_events ledger and shipments table. */
    @Autowired
