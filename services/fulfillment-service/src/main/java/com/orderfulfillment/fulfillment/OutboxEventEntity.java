 ...
 * business change it describes — V4__outbox_events.sql, ADR-006. Fulfillment Service's copy of
 * Order Service's {@code OutboxEventEntity}; see that class's Javadoc for the full rationale.
 */
@Entity
@Table(name = "outbox_events", schema = "fulfillment_service")
